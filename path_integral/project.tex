...
\be
  e^{- \beta \hat{H}} = e^{- \beta \hat{H}} = \lim_{P \to\infty} \Big[ e^{- \beta \hat{U}/2P} e^{-\beta \hat{K}/P} e^{-\beta{U}/2P} \Big]^P .
\ee
...
\be \label{eq:omega_mat}
  \braket{x_{k+1}|\Omega|x_k} = \braket{x+1|e^{-\beta \hat{U}/2P} e^{-\beta \hat{K}/P} e^{-\beta \hat{U}/2P}|x_k}
\ee
...
The solution to this equation, with proper normalization, is,
\be
