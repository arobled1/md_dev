...
\begin{figure}[H]
  ...
  \includegraphics[scale=1.1]{Figures/pimd/virial.pdf}
    \caption{Plot of the instantaneous virial estimator along with cumulative averages along a PIMD trajectory. Since the simulation was performed in using atomic units, we defined variables $\hbar = m = 1$ so that $\omega = 0.03$ and $K_BT = 0.03/15.8$. Simulations were considered successful if the cumulative average of the virial estimator converged at $E_{vir} = \hbar \omega / 2 = 0.015$. This simulation converged at a virial energy value of 0.01536 after 3 million MD steps with $\Delta t = 0.01$.}
\end{figure}
