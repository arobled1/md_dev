...
\ee
We can actually evaluate the sum to get a more compact form of the partition function by remembering that $\frac{1}{1-x} = \sum_n x^n$ and that $\hbar, \omega, and \beta$, are just constants.
\be
  \begin{split}
