...
As always, we will start with the case of a single quantum particle moving in one dimension.
So our Hamiltonian is the same as in equation (\ref{eq:harm_osc}).
