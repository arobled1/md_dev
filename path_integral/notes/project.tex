...
\subsection{Quantum Harmonic Oscillator Partition Function}
...
\be
  ...
  \end{split}
\ee
where the prefactors allow the math to work out nicely when deriving the energies for a harmonic oscillator.
The Hamiltonian can then be expressed in terms of the ladder operators.
\be
  \hat{H} = \hbar \omega(\hat{a}{\hat{a}^{\dagger}} + \frac{1}{2})
\ee

\subsection{Derivation of Path Integral for 1D Harmonic Oscillator}
