...
\subsection{Harmonic Oscillator Position Probability}
This section serves to derive the probability of finding a particular position of the harmonic oscillator in the canonical ensemble, equation (23).
We start with the canonical density,
\be
...
\ee
\subsection{Harmonic Oscillator Velocity Probability}
This section serves to derive the probability of finding a particular velocity of the harmonic oscillator in the canonical ensemble, equation (24).
We start with the canonical density,
\be
  f(x,v) = \frac{e^{- \beta H}}{\int dx \int dv e^{- \beta H}}
\ee
